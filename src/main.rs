...
async fn main (){
    ...
    // img_id
    let img_id: Result<String, Box<dyn Error>> = post_image("https://mail.google.com/mail/u/0?ui=2&ik=67634cf87e&attid=0.2&permmsgid=msg-f:1788368980422726673&th=18d1901ccd6c9411&view=fimg&fur=ip&sz=s0-l75-ft&attbid=ANGjdJ9EerK8r8XwB30B_wqzItfVozlutVZXOqkZ-ymMp50lz29_5xkrrPYIg3Maud6phd_Wi6QbJ4rJ5Mhu38dezoSgV8xEaGfi8MSpin26ccSu1YRksLMIXz0pW24&disp=emb&realattid=ii_18d18ff796490cac092".to_string()).await;
